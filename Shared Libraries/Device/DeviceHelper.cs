...
namespace Device
{
    // Source: https://stackoverflow.com/a/1610140/6237448
...
ref PropertyChangeParameters classInstallParams, int classInstallParamsSize);
    ...
    {
        public static void SetDeviceEnabled(this DeviceWMI deviceWMI, bool enable)
        {
            SetDeviceEnabled(new Guid(deviceWMI.ClassGUID), deviceWMI.DeviceID, enable);
        }
