...
namespace SimpleJournal
{
    public static class Consts
    {
        ...
        public static readonly string DotnetReleaseInfoUrl = "https://dotnetcli.blob.core.windows.net/dotnet/release-metadata/8.0/releases.json";
#if !DEBUG
        ...
        /// </summary>
        public static readonly Version CompiledDotnetVersion = new Version(8, 0, 1);
